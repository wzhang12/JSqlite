...
//        System.out.println(Database.getLibraryVersionNumber());
        ...
        conn.exec("DELETE FROM crashs WHERE id=2;");

        conn.setCommitHook(new CommitHook() {
            @Override
            public int callback(Object arg) {
                System.out.println("CommitHook");
        ...
        conn.setRollbackHook(new RollbackHook() {
            ...
            public void callback(Object arg) {
                System.out.println("RollbackHook");
                System.out.println(">>>>>>>>>>>>>>>>>>>>" + arg);
            }
        }, 2);
        ...
        transaction.begin();
        conn.exec("INSERT INTO crashs (id, name) values (2, 'Baker');");
